#!/usr/bin/env node
/**
 * Build docs/i18n-draft/pl/messages-app.pl.json from gemini-app-raw.json
 * Usage: node scripts/build-pl-app-draft.mjs
 */
import fs from "fs";
...
const rawPath = path.join(root, "docs/i18n-draft/pl/gemini-app-raw.json");
const outPath = path.join(root, "docs/i18n-draft/pl/messages-app.pl.json");
...
const out = {
  _meta: {
    ...
    toolNames: "Podanie / Bieg / Drybling",
