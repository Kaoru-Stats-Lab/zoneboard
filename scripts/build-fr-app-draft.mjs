#!/usr/bin/env node
/**
 * Build docs/i18n-draft/fr/messages-app.fr.json from gemini-app-raw.json
 * Usage: node scripts/build-fr-app-draft.mjs
 */
import fs from "fs";
...
const rawPath = path.join(root, "docs/i18n-draft/fr/gemini-app-raw.json");
const outPath = path.join(root, "docs/i18n-draft/fr/messages-app.fr.json");
