#!/usr/bin/env node
/**
 * Build docs/i18n-draft/pt/messages-app.pt.json from gemini raw.
 * Usage: node scripts/build-pt-app-draft.mjs
 */
import fs from "fs";
...
const rawPath = path.join(root, "docs/i18n-draft/pt/gemini-app-raw.json");
const outPath = path.join(root, "docs/i18n-draft/pt/messages-app.pt.json");
...
const out = {
  _meta: {
    ...
    toolNames: "Passe / Corrida / Drible",
