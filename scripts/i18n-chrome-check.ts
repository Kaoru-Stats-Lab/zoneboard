...
const CHROME_SHORT_PAIRS: [string, string][] = [
  ...
  ["captureCalibPresetFull", "captureCalibPresetFullShort"],
  ["captureCalibPresetLeft", "captureCalibPresetLeftShort"],
  ["captureCalibPresetRight", "captureCalibPresetRightShort"],
