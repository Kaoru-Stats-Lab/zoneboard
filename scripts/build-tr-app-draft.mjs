#!/usr/bin/env node
/**
 * Build docs/i18n-draft/tr/messages-app.tr.json from gemini-app-raw.json
 * Usage: node scripts/build-tr-app-draft.mjs
 */
import fs from "fs";
...
const rawPath = path.join(root, "docs/i18n-draft/tr/gemini-app-raw.json");
const outPath = path.join(root, "docs/i18n-draft/tr/messages-app.tr.json");
