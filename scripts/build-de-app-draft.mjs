#!/usr/bin/env node
/**
 * Build docs/i18n-draft/de/messages-app.de.json from gemini-app-raw.json
 * Usage: node scripts/build-de-app-draft.mjs
 */
import fs from "fs";
...
const rawPath = path.join(root, "docs/i18n-draft/de/gemini-app-raw.json");
const outPath = path.join(root, "docs/i18n-draft/de/messages-app.de.json");
