...
縦スクロール一枚はやめ、**浅いタブ 3 つ**にする（Canva / OBS の「ドック」感）。

| タブ | 中身 | 初見で開く？ |
|------|------|-------------|
| **試合** | ボード一覧、試合名、競技、ピッチ（全/半）、レーン、ベンチ、駒サイズ、フォーメ | 2回目以降 |
| **局面** | シーン一覧（チップ）、ラベル、半面隠し、画角プリセット | 局面を使う人 |
| **名簿** | Home/Away セグメント、貼り付け、スタメン、一括配置 | スタメン出す人 |

既定タブは **局面** か **試合** のどちらか一方に固定し、名簿は「必要な人が開く」。  
