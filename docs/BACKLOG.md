...
- UI **第1–3波 出荷済**（es·pt·pl · de·fr·tr · **it**）。[`LOCALE_MARKETS.md`](LOCALE_MARKETS.md) §3-8–9
...
| B-078 | UI 言語 it | **実装済** `/it/` · [`AGENT_PROMPT_I18N_IT.md`](AGENT_PROMPT_I18N_IT.md) · 3-back preset Later |
