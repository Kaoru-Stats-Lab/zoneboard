...
const ja: HowToDoc = {
  ...
  sections: [
    ...
    },
    {
      heading: "準備で描く",
      paragraphs: [
        "配信前にパス・ラン・ペン・リンクを引くなら、ツールレールを使います。Pass はボールの軌道（パス・クロス・シュート）。Run は走り。Dribble は運ぶ人です。",
        "ペンはパスでもランでもない一本です。ブロックの線、チャネルの境界。Shift を押したままドラッグすると直線になります（Figma と同じ）。丸や囲みは Shift なしの自由描きです。リンクは駒をクリックしてつなぎ、動かしても追従します（ライン構成向き）。",
      ],
      keys: [
        { combo: "Pass", meaning: "ボールの軌道（破線）。駒は動かない" },
        { combo: "Run / Dribble", meaning: "走り／ドリブル（駒からドラッグ可）" },
        { combo: "Pen", meaning: "自由記述のインク" },
        { combo: "Link", meaning: "駒どうしのリンク（追従）" },
