  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "R は向きを +45°。Shift+R で各駒を自チームの攻撃方向に揃えます。Ctrl+矢印で同じ方位に揃えます（←+↑ で斜めなど同時押し可）。形ごと回すのは Q / E（二人以上）。",
      ...
      keys: [
        ...
        { combo: "R", meaning: "向き +45°" },
        { combo: "Shift+R", meaning: "攻撃方向に揃える" },
        { combo: "Ctrl/Cmd+Arrow", meaning: "方位・斜めに揃える" },
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "R changes facing +45°. Shift+R snaps each piece to its team's attack direction. Ctrl/Cmd+arrows set a cardinal or diagonal (hold two arrows, e.g. Right+Up). Q / E rotate the whole shape around the selection centre. Select two or more pieces.",
      ...
      keys: [
        ...
        { combo: "R", meaning: "Facing +45°" },
        { combo: "Shift+R", meaning: "Snap to team attack" },
        { combo: "Ctrl/Cmd+Arrow", meaning: "Cardinal / diagonal facing" },
  ...
  sections: [
    ...
    },
    {
      ...
      keys: [
        ...
        { combo: "R", meaning: "Orientación +45°" },
        { combo: "Shift+R", meaning: "Alinear al ataque" },
        { combo: "Ctrl/Cmd+Arrow", meaning: "Misma dirección" },
  ...
  sections: [
    ...
    },
    {
      ...
      keys: [
        ...
        { combo: "R", meaning: "Orientação +45°" },
        { combo: "Shift+R", meaning: "Alinhar ao ataque" },
        { combo: "Ctrl/Cmd+Arrow", meaning: "Mesma direção" },
  ...
  sections: [
    ...
    },
    {
      ...
      keys: [
        ...
        { combo: "Shift+R", meaning: "Wyrównaj do ataku" },
        { combo: "Ctrl/Cmd+Arrow", meaning: "Jeden kierunek" },
  ...
  sections: [
    ...
    },
    {
      ...
      keys: [
        ...
        { combo: "R", meaning: "Blickrichtung +45°" },
        { combo: "Shift+R", meaning: "Auf Angriff ausrichten" },
        { combo: "Ctrl/Cmd+Arrow", meaning: "Gleiche Himmelsrichtung" },
  ...
  sections: [
    ...
    },
    {
      ...
      keys: [
        ...
        { combo: "R", meaning: "Orientation +45°" },
        { combo: "Shift+R", meaning: "Aligner vers l'attaque" },
        { combo: "Ctrl/Cmd+Arrow", meaning: "Même cardinal" },
  ...
  sections: [
    ...
    },
    {
      ...
      keys: [
        ...
        { combo: "R", meaning: "Yön +45°" },
        { combo: "Shift+R", meaning: "Hücuma hizala" },
        { combo: "Ctrl/Cmd+Arrow", meaning: "Aynı yöne çevir" },
  ...
  sections: [
    ...
    },
    {
      ...
      keys: [
        ...
        { combo: "R", meaning: "Orientamento +45°" },
        { combo: "Shift+R", meaning: "Allinea all'attacco" },
        { combo: "Ctrl/Cmd+Arrow", meaning: "Stessa direzione" },
